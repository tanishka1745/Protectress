...
import com.example.protectress.Speedo.Speedometer;
import com.google.android.material.floatingactionbutton.FloatingActionButton;

import java.math.BigDecimal;
import java.math.RoundingMode;

public class MagnoMag extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onResume() {
        ...
        if (!sharedpreferences.getBoolean(prevStarted, false)) {
            ...
            final AlertDialog.Builder alert = new AlertDialog.Builder(MagnoMag.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (magnetometer != null){
            sensorManager.registerListener(MagnoMag.this,magnetometer,SensorManager.SENSOR_DELAY_NORMAL);
        }else {
