...
public class ContactAdapter extends ArrayAdapter<ContactModal> {

    Context context;
    List<ContactModal>list;


    public ContactAdapter(@NonNull Context context,List<ContactModal>list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ContactModal c = getItem(position);
    ...
    public void refresh(List<ContactModal> list) {
        list.clear();
        list.addAll(list);
        notifyDataSetChanged();
    }
